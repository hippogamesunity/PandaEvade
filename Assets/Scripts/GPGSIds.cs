...
public static class GPGConstants
{
        ...
        public const string achievement_loaf = "CgkIh9b_1uACEAIQFA"; // <GPGSID>
        public const string achievement_tennis_ball = "CgkIh9b_1uACEAIQEQ"; // <GPGSID>
        public const string achievement_lifebuoy = "CgkIh9b_1uACEAIQFQ"; // <GPGSID>
        public const string achievement_boomerang = "CgkIh9b_1uACEAIQBA"; // <GPGSID>
        public const string leaderboard_player_scores = "CgkIh9b_1uACEAIQAQ"; // <GPGSID>
